...
import { Radio, Circle, Pause, Play, Video, Eye, ArrowRight, TriangleAlert } from "lucide-react";
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-zinc-300">
              {pendingProgramSwitch
                ? (
                    <>
                      Scene <span className="font-semibold text-zinc-50">{pendingProgramSwitch.sceneName}</span> may be unsafe to air live. Confirm to {pendingActionLabel}.
                    </>
                  )
